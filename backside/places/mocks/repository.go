...
// Source: sk8.town/backside/places (interfaces: PlacesRepository)
...
import (
	...
	errors "sk8.town/backside/errors"
...
func (m *MockPlacesRepository) GetPlaces(arg0, arg1 string) (*domain.GetPlacesResponse, *errors.AppError) {
	m.ctrl.T.Helper()
