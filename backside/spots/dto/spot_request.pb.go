...
type SpotRequest struct {
	...
	Coordinates *SpotCoordinates `protobuf:"bytes,3,opt,name=coordinates,proto3" json:"coordinates,omitempty"`
...
func (x *SpotRequest) GetCoordinates() *SpotCoordinates {
	if x != nil {
...
func (x *SpotCoordinates) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpotCoordinates) ProtoMessage() {}

func (x *SpotCoordinates) ProtoReflect() protoreflect.Message {
	mi := &file_proto_spot_request_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpotCoordinates.ProtoReflect.Descriptor instead.
func (*SpotCoordinates) Descriptor() ([]byte, []int) {
	return file_proto_spot_request_proto_rawDescGZIP(), []int{1}
}

func (x *SpotCoordinates) GetLat() float64 {
	if x != nil {
		return x.Lat
	}
	return 0
...
func (x *SpotCoordinates) GetLong() float64 {
	if x != nil {
		return x.Long
	}
	return 0
...
var file_proto_spot_request_proto_rawDesc = []byte{
	...
	0x22, 0xc8, 0x01, 0x0a, 0x0b, 0x53, 0x70, 0x6f, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	...
	,
	...
	0x6c, 0x6f, 0x6e, 0x67, 0x42, 0x07, 0x5a, 0x05, 0x2e, 0x2f, 0x64, 0x74, 0x6f, 0x62, 0x06, 0x70,
...
var file_proto_spot_request_proto_goTypes = []interface{}{
	...
	(*SpotCoordinates)(nil), // 1: main.SpotCoordinates
}
var file_proto_spot_request_proto_depIdxs = []int32{
	1, // 0: main.SpotRequest.coordinates:type_name -> main.SpotCoordinates
